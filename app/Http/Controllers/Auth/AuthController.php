...
class AuthController extends Controller
{
    ...
    */
    ...
    /**
     * Handle a login request to the application. Override default
     *
    ...
    /**
     * Get the failed login response instance. Override default
     *
     * @param \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\Response
     */
    protected function sendFailedLoginResponse(Request $request, $active = 1)
    {
        if ($active) {
